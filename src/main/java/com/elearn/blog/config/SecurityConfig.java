...
public class SecurityConfig {
	...
	public static final String[] PUBLIC_URLS = { "/api/v1/auth/login/" , "/api/v1/auth/fp/**" , "/api/blogs/search/**","/api/v1/auth/register/", "/apis/users/", "/api/v1/users/pfp/**", "/api/v1/users/forgotPassword/**"};
